  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience freedom on the road with Car Sharing Application, your reliable partner for flexible, affordable, and convenient car-sharing solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience freedom on the road with Car Sharing Application, your reliable partner for flexible, affordable, and convenient car-sharing solutions.`}
            </Text>
            <Box
